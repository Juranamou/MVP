  ...
  return (
    <div>
      <Row>
        ...
        <Paragraph>SilentSpy utilizes a web scraper and the ebay API to allow users to make informed purchases by comparing the current listing prices to previously sold items. The application also allows users to input their email, ebay query, and target price to be notified when their interests reach a certain value.</Paragraph>
      </Row>
    </div>
  )
}
